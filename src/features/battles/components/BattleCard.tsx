      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        <div className="flex-1">
          ...
          <Link
            ...
            onClick={(e) => selectable && e.preventDefault()}
          >
            <h3 className="text-foreground decoration-primary/30 group-hover:text-primary mt-1.5 line-clamp-2 text-sm leading-snug font-bold decoration-2 underline-offset-4 transition-all hover:underline">
              {battle.title}
            </h3>
          </Link>
